...
| **2** | ~~Workflow engine decision + durable-suspend spike~~ **DONE 2026-08-06** | Proven cross-process suspend/resume, with real OpenCode turns either side of the gate. LangGraph 1.2.10 on Python 3.13. The exploratory code was retired after the product-level durability test superseded it. [ADR-003](decisions/ADR-003-workflow-engine-and-durable-gates.md) | 1 |
